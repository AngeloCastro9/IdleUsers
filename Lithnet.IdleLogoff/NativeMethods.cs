    ...
    public class NativeMethods
    {
        ...
        public static void LogOffUser()
        {
            ...
            try
            {
                ...
                // para ignorar o administrator, pode ser fazer um if neste local para ignorar o mesmo
                //LblUsu.Text = System.Security.Principal.WindowsIdentity.GetCurrent().Name.Substring(4); -- essa é a linha
